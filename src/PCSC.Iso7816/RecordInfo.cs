...
namespace PCSC.Iso7816
{
    ...
    public class RecordInfo
    {
        ...
        public RecordInfo(byte fileDescriptor) {
            ...
            // IsCyclic
            if (fileDescriptor.IsSet(FILE_STRUCTURING_MASK, FILE_STRUCTURE_IS_CYCLIC)) {
                IsCyclic = true;
            ...
            if (!IsCyclic) {
                ...
                // IsFixed
                if (fileDescriptor.IsSet(FILE_STRUCTURING_MASK, FILE_STRUCTURE_IS_LINEAR_FIXED)) {
                    IsFixed = true;
                }

                // IsVariable
                if (fileDescriptor.IsSet(FILE_STRUCTURING_MASK, FILE_STRUCTURE_IS_LINEAR_VARIABLE)) {
                    IsVariable = true;
                }
            }

            // IsSimpleTlv
            if (fileDescriptor.IsSet(1, 1)) {
                IsSimpleTlv = true;
            }
        }
